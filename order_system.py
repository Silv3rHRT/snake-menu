def place_order(menu):
    ...
    while True:
        ...
        print("Take a look over the menu and see what you'd like to order")
        ...
        menu_selection = input("Enter the menu item number you would like to order: ")

        # Update the order list using the update_order function
        order = update_order(order, menu_selection, menu_items)

        # Ask the customer if they would like to order anything else
        another_item = input("Would you like to order anything else? (type 'n' or 'N' to quit): ")
...
def update_order(order, menu_selection, menu_items):
    ...
    if menu_selection.isdigit():
        ...
        if menu_selection in menu_items:
            ...
            # When the user's input isn't valid, tell the customer that their input isn't valid
            print("Invalid menu selection. Please try again.")
    else:
        # When the menu selection wasn't valid:
        print(f"{menu_selection} is not a valid menu option. Please enter a number.")
